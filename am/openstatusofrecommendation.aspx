                ...
                <center>
                    <table class="table table-responsive table-condenced table-hover" style="width: 90%;">
                        ...
                        <tr id="extrecom<%Response.Write(recomreader["recomId"]);%>"><th>የሁኔታው መጠን</th>
                         <td><textarea class="form-control" id="ext<%Response.Write(recomreader["recomId"]);%>" style="border:1px solid #552222" placeholder="የሁኔታው መጠን.."><%Response.Write(recomreader["statusExtent"]);%></textarea>
