  ...
  %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
       ...
       <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../en/auditeehome.aspx"><img src="images/eng.png" width="20" height="10"/>English</a></div>
   <div class="row">
  ...
  <div class="panel panel-default" style="background-color:#c2c9cb; height:1000px;border-right:1px solid black">
        <div class="navbar navbar-default">
            <ul class="nav sidebar-nav btn-primary ">
                       <li style="border-bottom: 2px solid #ffffff;"><a href="auditeeaccountsetting.aspx" style="background-color:#c2c9cb;"><b  style="color:black;">የመለያ መቸት</b></a></b></li>
    ...
    <a href="auditeehome.aspx" class="navbar-brand" style="color:black"><b>ዋና ገጽ</b></a>
     </div>
     
     <div class="navbar-header">
    <a href="auditeeaboutofag.aspx" class="navbar-brand" style="color:black"><b>ስለ OFAG</b></a>
     </div>
     <div class="navbar-header">
    ...
    <li ><a href="#" onclick="$('#plan').slideDown(0);$('#taken').slideUp(0);$('#uppltkn').slideDown(0);$('#rplan').slideUp(0);$('#rtplan').slideUp(0);" >የድርጊት ዕቅድ ፋይል ይላኩ</a></li>
    <li ><a href="#" onclick="$('#plan').slideUp(0);$('#taken').slideDown(0);$('#uppltkn').slideDown(0);$('#rplan').slideUp(0);$('#rtplan').slideUp(0);" >የተወሰደ እርምጃ ፋይል ይላኩ</a></li>
    <li ><a href="#" onclick="$('#plan').slideUp(0);$('#taken').slideUp(0);$('#uppltkn').slideUp(0);$('#rplan').slideDown(0);$('#rtplan').slideUp(0);" >የድርጊት ዕቅድ ይመዝግቡ</a></li>
    <li ><a href="#" onclick="$('#plan').slideUp(0);$('#taken').slideUp(0);$('#uppltkn').slideUp(0);$('#rplan').slideUp(0);$('#rtplan').slideDown(0);" >የተወሰደ እርምጃ ይመዝግቡ</a></li>
    </ul>
    ...
    <asp:Label ID="lab" runat="server"></asp:Label>
       ...
       <tr><th colspan="2"  style="background-color:#c2c9cb">የድርጊት ዕቅድ ፋይል ይላኩ</th></tr>
       <tr><th>የኦዲት ዓ/ም ይምረጡ (E.c.)</th>
       <td>
     ...
     <select class="form-control" id="selaudittype" style="border:1px solid black" runat="server">
       ...
       <tr><th>የድርጊት ዕቅድ ፋይል ይምረጡ</th>
       <td><input type="file" id="FileUploadControl" runat="server" class="btn btn-info"/>
       </td>
       </tr>
       <tr><td><asp:Label ID="msg" style="color:blue" runat="server"></asp:Label></td><td><asp:Button runat="server" Text="ፋይል ይላኩ" OnClick="uploadfile" class="btn btn-primary"/></td></tr>
       </table>

       <!--action taken-->
        <table class="table table-responsive table-condensed table-hover table-bordered table-striped" id="taken" style="display:none">
       <tr><th colspan="2" style="background-color:#c2c9cb">የተወሰደ እርምጃ ፋይል ይላኩ</th></tr>
       <tr><th>የኦዲት ዓ/ም ይምረጡ (E.c.)</th>
       <td>
     ...
     <select class="form-control" id="selaudittype2" style="border:1px solid black" runat="server">
       ...
       <tr><th>የተወሰደ እርምጃ ፋይል ይምረጡ</th>
       <td><input type="file" id="FileUploadControl2" runat="server" class="btn btn-info"/>
       </td>
       </tr>
       <tr><td><asp:Label ID="msg2" style="color:blue" runat="server"></asp:Label></td><td><asp:Button ID="Button1" runat="server" Text="ፋይል ይላኩ" OnClick="uploadfile2" class="btn btn-primary"/></td></tr>
       </table>
    </form>
    <div class="row" id="uppltkn">
    <div class="col-sm-6" style="padding-right:0px;">
    <table class="table table-condensed table-bordered table-hover table-responsive">
    <tr><td colspan="2" style="background-color:#c2c9cb;color:black">የተላኩ የድርጊት ዕቅድ ፋይሎች (ለማውረድ የሚረዳውን አገናኝ ላይ ጠቅ ያድርጉ)</td></tr>
    <%try
      {
          con.Open();
    ...
    <table class="table table-condensed table-bordered table-hover table-responsive">
    <tr><td colspan="2" style="background-color:#c2c9cb;color:black">የተላኩ የተወሰዱ እርምጃ ፋይሎች (ለማውረድ የሚረዳውን አገናኝ ላይ ጠቅ ያድርጉ)</td></tr>
    <%try
      {
          con.Open();
    ...
    <tr><th colspan="3" style="background-color:#c2c9cb">የድርጊት ዕቅድ ለመመዝገብ ኦዲት ይፈልጉ</th></tr>
    <tr><th>የኦዲት ዓ/ም ይምረጡ</th><th>የኦዲት አይነት ይምረጡ</th><th></th></tr>
    <tr><td>
    ...
    <td>
    <button class="btn btn-primary" onclick="showrecommendations()"><span class="glyphicon glyphicon-search"></span> ፈልግ</button>
    </td>
    </tr>
    </table>
    <div id="hidrecom">
    ...
    <table class="table table-responsive table-condensed table-hover table-striped table-bordered">
     <tr><th colspan="3" style="background-color:#c2c9cb">የተወሰዱ እርምጃዎችን ለመመዝገብ ኦዲት ይፈልጉ</th></tr>
    <tr><th>የኦዲት ዓ/ም ይምረጡ</th><th>የኦዲት አይነት ይምረጡ</th><th></th></tr>
    <tr><td>
    ...
    <td>
    <button class="btn btn-primary" onclick="showactionplan()"><span class="glyphicon glyphicon-search"></span>ፈልግ</button>
    </td>
    </tr>
    </table>
    <div id="hidplan">
