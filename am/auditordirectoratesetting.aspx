...
<% string conString = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
 ...
 %>
  <h4><span class="glyphicon glyphicon-plus"></span>አዲስ የኦዲት ዳይሬክቶሬት መዝግብ</h4>
 <center> <span id="dirmsg"></span><table class="table" style="width:70%">
 <tr><td colspan="2"><input type="text" class="form-control" id="dir" placeholder="የኦዲት ዳይሬክቶሬት"></td></tr>
 <tr><td style="width:50%"></td><td><button class="btn btn-primary btn-block" onclick="savedirectorate()">መዝግብ</button></td></tr>
  </table>
  </center>
  <hr style="border:2px solid #777777">
    <h4><span class="glyphicon glyphicon-folder-close"></span>የተመዘገቡ የኦዲት ዳይሬክቶሬቶች</h4>
    <table class="table">
    <%
        try
        {
