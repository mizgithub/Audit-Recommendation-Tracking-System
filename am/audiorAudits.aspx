  ...
  %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
      ...
      <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../en/audiorAudits.aspx"><img src="images/eng.png" width="20" height="10"/>English</a></div>
   <div class="row">
   ...
   <div class="panel panel-default" style="background-color:#c2c9cb; height:1000px;border-right:1px solid black">
    ...
    <!--************************************************-->
     ...
     <tr><th style="background-color:#c2c9cb;height:40px;color:black" valign="center"><span class="glyphicon glyphicon-floppy-disk"></span> የተመዘገቡ ኦዲቶች</th></tr>
     </table>
     ...
     <%
         try
         {
             ...
             while (auditreader.Read()) {
                 ...
                 con2.Close();
             %>
             <tr><td style="width:20px;"><button class="btn btn-link" onclick="openAudit(<%Response.Write(auditreader["auditId"]);%>)"><span class="glyphicon glyphicon-folder-close"></span>ክፈት</button></td><td style="width:200px;"><%Response.Write(auditreader["auditName"]);%></td><td><%Response.Write(auditee);%></td></tr>
             <%
             }
             con.Close();
         }
    ...
    <table class="table" style="background-color:#c2c9cb;color:black;height:40px;"><tr><th><b>ኦዲት ፈልግ</b></th></tr></table>
