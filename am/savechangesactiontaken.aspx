...
<%
   ...
   {
       con.Open();
       new SqlCommand("update actiontaken_Table set actiontaken=N'" + actiontaken + "',actiondate='" + actiondate + "',recoveredvalue="+recvalue+" where actiontakenId=" +actiontakenId, con).ExecuteNonQuery();
       con.Close();
