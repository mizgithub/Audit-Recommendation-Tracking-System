...
<%
   ...
   %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
       ...
       <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../en/auditor_recordnewAudit.aspx"><img src="images/eng.png" width="20" height="10"/>English</a></div>
   <div class="row">
   <div class="col-sm-2 panel panel-default" style="background-color:#c2c9cb; height:1000px;border-right:1px solid black;padding-right:0px;">
    ...
    <ul class="nav nav-pills btn-sm" style="padding:10px;">
            <%if (Request["back"] != "" && Request["back"] != null) { 
              %>
              <li style=""><a href="Auditor_showAudit.aspx?auditId=<%Response.Write(Request.Cookies["auditId"].Value);%>"  class="btn btn-link btn-sm"><b><span class="glyphicon glyphicon-backward"></span>ወደ ኋላ መልስ</b></a></li>
              <%
              }%>
    ...
    <table class="table table-responive table-condensed table-bordered table-hover table-striped" style="border:1px solid #c2c9cb;">
     <tr style="background-color:#c2c9cb;"><td colspan="6"><h4 style="color:black"><b>የኦዲቱ አጠቃላይ መረጃ</b></h4></td></tr>
       ...
       <%
           ...
           try
           {
               if (Request.Cookies["auditId"].Value != "")
               {
                   ...
                   while (auditreader.Read())
                   {
                       ...
                       con2.Close();
                %>
               <tr><th style="width:15%">ማሻቀሻ ቁጥር</th><td><%Response.Write(auditreader["refNo"]);%></td></tr>
               <tr><th>የኦዲት ርዕስ</th><td><%Response.Write(auditreader["auditName"]);%></td></tr>
               <tr><th>ተገምጋሚ ድርጅት</th><td><%Response.Write(auditee);%></td></tr>
               ...
               <tr><th>የኦዲት ጊዜ</th><td><%Response.Write(auditreader["startdate"] + "<b>----</b>" + auditreader["enddate"]);%></td></tr>
               <%
                   }
                   con.Close();
               }
        ...
        %>
        <tr><td colspan="6"><button class="btn btn-primary" onclick="$('#auditsaving').slideToggle();$('#auditeditting').slideToggle();"><span class="glyphicon glyphicon-edit"></span>አድስ</button></td></tr>
        </table>
    </div>
    ...
    <tr style="background-color:#c2c9cb;color:black"><td colspan="4"><h4><b>የኦዲቱ አጠቃላይ መረጃ</b></h4></td></tr>
    <tr>
    <th style="width:100px">ማጣቀሻ ቁጥር</th>
    <td><input type="text" class="form-control" id="audrefno" placeholder="ማጣቀሻ ቁጥር" style="border:1px solid #c2c9cb" value="<%Response.Write(refno);%>"></td>
     <th>የኦዲት ርዕስ</th>
    <td><input type="text" class="form-control" id="audittitle" placeholder="የኦዲት ርዕስ" style="border:1px solid #c2c9cb" value="<%Response.Write(auditname);%>">
    </td>
    </tr><tr>
    <th>ተገምጋሚ ድርጅት</th>
    <td>
    ...
    <%if (Request.Cookies["auditId"].Value != "")
      {%>
        <button class="btn btn-primary"  onclick="editauditInfo()">ለዉጦችን መዝግብ</button> <button class="btn btn-primary"  onclick="$('#auditsaving').slideToggle();$('#auditeditting').slideToggle();">አቋርጥ</button></td></tr>
    <%}
      else
      { %>
    <button class="btn btn-primary" onclick="saveauditInfo()">መዝግብ</button><%} %><span id="auditmsg"></span></td></tr>
    </table>
    </div>
    <%
 ...
 <div style="padding-left:10px;padding-right:20px;">
    ...
    <tr style="background-color:#c2c9cb"><th colspan="5"><h4><b style="color:black">ኦዲተር</b></h4></th></tr>
    <tr><th colspan="5"><ul class="nav nav-pills"><li><a class="btn btn-link" onclick="$('#hidrow1').slideToggle();"><b><span class="glyphicon glyphicon-plus"></span>ኦዲተር ጨምር</b></a></li></ul></th></tr>
    <tr style="display:none" id="hidrow1"><td colspan="5"><table class="table table-responsive" border="1">
    <tr><th>ስም</th><th>የአባት ስም</th><th>ደረጃ</th><th>ዳይሬክቶሬት</th></tr>
    ...
    <th><select class="form-control" id="auddir">
      <% 
          ...
          <%if (auditId != 0)
            {%>
        <tr><td colspan="4"><button class="btn btn-primary" onclick="saveauditor()">መዝግብ</button><span id="auditormsg"></span></td></tr>
         <%} %>
    </table>
    </td></tr>
    <% try
       {
           ...
           while (revreader.Read()) { 
             %>
             <tr><th style="width:7px;"><button class="btn btn-link" title="አጥፋ" style="color:Red;"onclick="deleteauditor(<%Response.Write(revreader["idno"]);%>)"><span class="glyphicon glyphicon-minus-sign"></span></button></th><th style="width:7px"><button title="አድስ" class="btn btn-link" onclick="$('#hidrow1<%Response.Write(revreader["idno"]);%>').slideToggle();"><span class="glyphicon glyphicon-edit"></span></button></th><th><%Response.Write(revreader["fname"] + " " + revreader["lname"]);%></th><th><%Response.Write(revreader["rank"]);%></th><th><%Response.Write(revreader["directorate"]);%></th></tr>
             ...
             <tr><td><button class="btn btn-primary" onclick="editauditorinfo(<%Response.Write(revreader["idno"]);%>)"><b>ለውጦችን መዝግብ</b></button><span id="editauditormsg<%Response.Write(revreader["idno"]);%>"></span></td></tr>
             </table>
             </center>
             </td></tr>
             <%
   ...
   <table class="table table-responsive table-bordered table-condensed table-striped" style="border-bottom:1px dotted #552222">
    <tr style="background-color:#c2c9cb"><th colspan="5"><h4><b style="color:black">የኦዲቱ ገምጋሚ</b></h4></th></tr>
    <tr><th colspan="5"><ul class="nav nav-pills"><li><a class="btn btn-link" onclick="$('#hidrow').slideToggle();"><b><span class="glyphicon glyphicon-plus"></span>ገምጋሚ ጨምር</b></a></li></ul></th></tr>
    <tr style="display:none" id="hidrow"><td colspan="5"><table class="table table-responsive" border="1">
    <tr><th>ስም</th><th>የአባት ስም</th><th>ደረጃ</th><th>ቀን</th></tr>
    ...
    <th><input type="date" class="form-control" id="revdate"></th>
         ...
         <%if (auditId != 0)
         {%>
        <tr><td colspan="4"><button class="btn btn-primary" onclick="savereviewer()">መዝግብ</button><span id="revmsg"></span></td></tr>
       <%} %>
    </table>
    </td></tr>
    <% try
       {
           ...
           while (revreader.Read()) { 
             ...
             <tr><td><button class="btn btn-primary" onclick="editreviewerinfo(<%Response.Write(revreader["revId"]);%>)"><b>ለውጦችን መዝግብ</b></button><span id="revmsg<%Response.Write(revreader["revId"]);%>"></span></td></tr>
             </table>
             </center>
             </td></tr>
             <%
   ...
   &nbsp; <%if (Request.Cookies["auditId"].Value != "")
     ...
     <tr><td colspan="2"><a href="auditor_recordfindingsAndRecommendations.aspx" class="btn btn-link" style="background-color:#3479c6;color:white">የኦዲት ግኝት እና ማሻሻያ ሃሳብ መዝግብ</a></td><td></td></tr>
     </table>
            <%} %>
            </div>
    </div>
