...
<script type="text/javascript">
    ...
    function changestatusofrecommendation(recomId) {
        if (confirm("you are about to change the status of recommendation.\nPress OK to continue")) {
            var http = new XMLHttpRequest();
            http.onreadystatechange = function () {
                if (this.readyState == 4 && this.status) {
                    showdetailfidingrecom();
                }
            };
            http.open("GET", "changestatusofrecommendation.aspx?recomId=" + recomId + "&&status=" + document.getElementById("status" + recomId).value, true);
            http.send();
        }
    }
</script>
   ...
   <% string conString = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
    ...
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
      ...
      <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../en/Ag_showaudit.aspx?auditId=<%Response.Write(Request["auditId"]);%>"><img src="images/eng.png" width="20" height="10"/>English</a></div>
   <div class="row">
    <div class="col-sm-2" style="padding-right:0px;background-color:#eeddcc">
<div class="panel panel-default" style="background-color:#c2c9cb; height:1000px;border-right:1px solid black">
    ...
    <table class="table table-responsive table-condensed">
      ...
      <%string remark = "";
        string opinion = "";
          try
          {
              ...
              while (auditreader.Read()) {
                  ...
                  <tr><th>የክትትል ቀን</th><td><%Response.Write(auditreader["followupdate"]);%></td></tr>
                      ...
                      try
                      {
                       con.Open();
                          ...
                          while (auditorreader.Read()) { 
                           %>
                           <tr><th>ኦዲተሩ</th><td><%Response.Write(auditorreader["fname"] + " " + auditorreader["lname"] + "&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>Rank: <U>" + auditorreader["rank"] + "</u> </i>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<i>Directorate <u>" + auditorreader["directorate"] + "</u></i>");%></td></tr>
                           <%
                          }
                          con.Close();
                          con.Open();
           ...
           <tr><th>የኦዲተሩ ተጨማሪ ሃሳብ</th><td><%Response.Write(remark);%></td></tr>
           <tr><td colspan="2"><hr></td></tr>
           <%try {
                 con.Open();
                 ...
                 while (nextstepreader.Read()) { 
                    %>
                    <tr><th>የኦዲተሩ ቀጣይ እርምጃ</th><td><%Response.Write(nextstepreader["nextstep"]);%></td></tr>
        ...
        <tr style="color:black"><th colspan="5" style="font-size:16px;">የኦዲቱ ግኝቶች እና ማሻሻያ ሃሳቦች</th></tr>
        <%try
          {
              con.Open();
              int nooffinding = 0;
              ...
              con.Close();
              %>
              <tr ><th colspan="5">የኦዲቱ ግኝቶች</th></tr>
              <tr><th>አጠቃላይ የግኝቶች ቁጥር</th><th>የግኝቶች ጠቅላላ የፋይናንስ እሴት</th><th>የግኝቶች ግምታዊ የገንዘብ ቅኝት ጠቅላላ ዋጋ</th><th></th><th></th></tr>
              ...
              con.Close();
               %>
                <tr style="background-color"><th colspan="5">የኦዲቱ ማሻሻያ ሃሳቦች</th></tr>
              <tr><th>አጠቃላይ የማሻሻያ ሃሳቦች ቁጥር</th><th>አጠቃላይ የማሻሻያ ሃሳቦች ግምታዊ የፋይናንስ እሴት</th><th style="">ጠቅላላ በከፊል የተተገበሩ የማሻሻያ ሃሳቦች</th><th style="background-color:">ጠቅላላ ሙሉ በሙሉ የተተገበሩ የማሻሻያ ሃሳቦች</th><th style="background-color">ጠቅላላ ያልተተገበሩ የማሻሻያ ሃሳቦች</th></tr>
