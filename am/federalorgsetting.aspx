...
<% string conString = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
 ...
 %>
  <h4><span class="glyphicon glyphicon-plus"></span>አዲስ ተገምጋሚ ድርጅት መዝግብ</h4>
 <center> <span id="orgmsg"></span><table class="table" style="width:70%">
 <tr><td colspan="2"><input type="text" class="form-control" id="fedorg" placeholder="ተገምጋሚ ድርጅት"></td></tr>
  <tr><td colspan="2">
   <p>ተገምጋሚው ድርጅት የሚመደብበትን የኦዲት ዳይሬክቶሬት ምረጥ</p>
 ...
 <tr><td style="width:50%"></td><td><button class="btn btn-primary btn-block" onclick="savefederalorg()">መዝግብ</button></td></tr>
  </table>
  </center>
  <hr style="border:2px solid #777777">
    <h4><span class="glyphicon glyphicon-folder-close"></span>የተመዘገቡ ተገምጋሚ ድርጅቶች</h4>
    <table class="table">
    <%try
      {
          con.Open();
