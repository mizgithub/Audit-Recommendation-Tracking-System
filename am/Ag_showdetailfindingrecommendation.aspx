...
<tr style="color:black"><th colspan="10" style="font-size:16px;">የኦዲቱ ግኝቶች እና የማሻሻያ ሃሳቦች ዝርዝር</th></tr>
   ...
   try
   {
      ...
      <td><b>የፋይናንስ እሴት (ETB.)</b><br><%Response.Write(double.Parse(findingreader["actualValue"].ToString()).ToString("#,0.00"));%></td><td><b>ግምታዊ የፋይናንስ እሴት( ETB.)</b><br><%Response.Write(double.Parse(findingreader["extraValue"].ToString()).ToString("#,0.00"));%></td><td><b>የተገኘው የገንዘብ ዋጋ (ETB.)</b><br><%Response.Write(totrecvalue.ToString("#,0.00"));%></td><td><b>ያልተገኘ የገንዘብ ዋጋ (ETB.)</b><br><%Response.Write((double.Parse(findingreader["actualValue"].ToString())-totrecvalue).ToString("#,0.00"));%></td></tr>
         <tr><td colspan="10"><center><table class="table table-responsive table-condensed table-bordered table-striped" style="width:98%;">
        <tr style="color:black;font-size:18px;"><th colspan="9">የማሻሻያ ሃሳቦች</th></tr>
        <%
           con2.Open();
           ...
           while (recomreader.Read()) {
               ...
               {
            %>
            <th style="border-top:"><b style="font-size:18px">የማሻሻያ ሃሳብ<%Response.Write(recomcounter++);%></b></th><td style="border-top:"><%Response.Write(recomreader["recomName"]);%></td><td style="border-top:">ግምታዊ የፋይናንስ እሴት<br><%Response.Write(double.Parse(recomreader["potSaving"].ToString()).ToString("#,0.00"));%></td>
            ...
            <%
               ...
               { 
                   %>
            <th style="border-top:2"><b style="font-size:18px">የማሻሻያ ሃሳብ<%Response.Write(recomcounter++);%></b></th><td style="border-top:"><%Response.Write(recomreader["recomName"]);%></td><td style="border-top:">ግምታዊ የፋይናንስ እሴት<br><%Response.Write(recomreader["potSaving"]);%></td>
            ...
            <%
             ...
             %>
           <th style="border-top:"><b style="font-size:18px">የማሻሻያ ሃሳብ<%Response.Write(recomcounter++);%></b></th><td style="border-top:"><%Response.Write(recomreader["recomName"]);%></td><td style="border-top:">ግምታዊ የፋይናንስ እሴት<br><%Response.Write(recomreader["potSaving"]);%></td>
            <td style="border-top:;width:200px;"><u><b>አሁን ያለበት ሁኔታ</b></u><br>
            ሙሉ በሙሉ ተተግብሯል
            </td>
            <%
            ...
            <tr style="background-color:;color:black;font-size:18px;border-top:;border-bottom:;"><th colspan="2">የድርጊት ዕቅድ</th></tr>
            <%
               con3.Open();
               ...
               while (actionplanreader.Read()) {
                   ...
                   {
                %>
                <tr><td><%Response.Write(actionplanreader["actionplan"]);%></td><td style="width:200px;background-color:">Action plan date:<br><b style="color:blue"><%Response.Write(actionplanreader["actiondate"]);%></b><span style="color:red">ቀነ-ገደቡን አምልጦታል</span></td></tr>
                ...
                <tr><td><%Response.Write(actionplanreader["actionplan"]);%></td><td style="width:200px;background-color:">ቀነ-ገደብ:<br><b style="color:blue"><%Response.Write(actionplanreader["actiondate"]);%></b></td></tr>
                  ...
                  <tr><th>ተ.ቁ.</th><th>የተወሰደ እርምጃ</th><th>የተገኘው የገንዘብ ዋጋ(ETB.)</th><th>እርምጃ የተወሰደበት ቀን</th></tr>
