 ...
 <% string conString = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
   ...
   %>
    <div class="" style="height:70px;">
     ...
     <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../en/admin_showaudits.aspx?auditId=<%Response.Write(Request["auditId"]); %>"><img src="images/eng.png" width="20" height="10"/>English</a></div>
   <div class="row">
