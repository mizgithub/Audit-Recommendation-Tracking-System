...
<%
    ...
    <div class="" style="height: 70px;">
      ...
      <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../en/auditor_recordfindingsAndRecommendations.aspx"><img src="images/eng.png" width="20" height="10"/>English</a></div>
    <div class="row">
    ...
    <a href="logout.aspx" class="navbar-brand" style="color:black"><b>ውጣ</b></a>
            ...
            <li style=""><a href="auditor_recordnewAudit.aspx"><b><span class="glyphicon glyphicon-backward"></span>ወደ ኋላ መልስ</b></a></li>
            ...
            <div class="row">
                    ...
                    <table class="table table-condensed table-responsive table-bordered table-striped" style="border: 2px solid #c2c9cb; background-color:white; padding: 5px;">
                        <tr style="background-color:#c2c9cb">
                            <th colspan="4" style="color: black">
                                <h4><b><span class="glyphicon glyphicon-record"></span>ግኝት መዝግብ</b></h4>
                            </th>
                        </tr>
                        <tr>
                            <td colspan="2" rowspan="2">
                                <textarea class="form-control" id="finding" placeholder="ግኝቱን እዚህ ጻፍ..."
             ...
             con.Close();
                        ...
                        <tr>
                         <th>የወረቀት ማጣቀሻ</th>
                        <td>
                        <input  type="text" class="form-control" id="pref" style="border: 1px solid #c2c9cb" placeholder="የወረቀት ማጣቀሻ">
                        </td>
                           
                        
                       
                            <th style="width:100px;">
                               የግኝቱ ግምታዊ የፋይናንስ እሴት(ETB.)
                            </th>
                            <td>
                        ...
                        <tr>
                            ...
                            <td rowspan="3">
                            <p>ሁለት ወይም ከዚያ በላይ አማራጮችን ለመምረጥ በቁልፍ ሰሌዳው ላይ <kbd>ctrl</kbd> ን ይጫኑ እና አማራጮችን ጠቅ ያድርጉ</p>
                                ...
                                <br>
                                <p style="">አዲስ የግኝቶች ምንጭ እዚህ አክል. ከአንድ በላይ የግኝቶች ምንጭን ለመለየት ኮራ (,) ይጠቀሙ</p>
                                <input type="text" id="sourcetxt" class="form-control" placeholder="አዲስ የግኝት ምንጭ" style="border: 1px solid #c2c9cb">
                            </td>
                        
                        <th>የተገምጋሚ ድርጅቱ ምላሽ</th>
                        <td><textarea id="audresp" placeholder="የተገምጋሚ ድርጅቱ ምላሽ..." class="form-control" rows="4" style="border: 1px solid #c2c9cb;"></textarea></td>
                        </tr>
                        <tr><th>ምላሹን የሰጠው የድርጅቱ ተውካይ</th><td><input type="text" id="respfname" style="border: 1px solid #c2c9cb" class="form-control" placeholder="ስም">&nbsp<input type="text" id="resplname" style="border: 1px solid #c2c9cb;" class="form-control" placeholder="የአባት ስም"></td></tr>
                        <tr><th>ምላሽ የተሰጠበትቀን(E.C)</th>
                    ...
                    <table class="table table-condensed table-responsive table-bordered table-striped">
                        <tr style="background-color:#c2c9cb">
                            <th colspan="5" style="color: black"><h4><b>
                                <span class="glyphicon glyphicon-saved"></span>የተመዘገቡ ግኝቶች</b></h4>
                            </th>
                        </tr>
                        <%try
                          {
                        ...
                        <tr>
                            ...
                            <th>
                                የግኝቱ ትክክለኛ የፋይናንስ እሴት
                            </th>
                            <th>
                               የግኝቱ ግምታዊ የፋይናንስ እሴት
                            </th>
                        </tr>
                        <%
            }
            ...
            { 
                        ...
                        <tr>
                            <td style="width:7px;">
                                <button class="btn btn-link" title="አድስ" onclick="$('#hidfinding<%Response.Write(findingReader["findingId"]);%>').slideToggle();">
                                    <span class="glyphicon glyphicon-edit"></span>
                                </button></td>
                                <td style="width:7px;">
                                 <button class="btn btn-link" title="አጥፋ" onclick="deletefinding('<%Response.Write(findingReader["findingId"]);%>')">
                                        ...
                                        <tr>
                                            <td colspan="2" rowspan="2">
                                                <textarea class="form-control" id="edfinding<%Response.Write(findingReader["findingId"]);%>"
                                                    placeholder="ግኝቱን እዚህ ጻፍ..." rows="5" style="border: 1px solid #c2c9cb"><%Response.Write(findingReader["findingName"]);%></textarea>
                                            </td>
             ...
             con2.Close();
                        ...
                        <td><textarea id="edaudresp<%Response.Write(findingReader["findingId"]);%>" class="form-control" rows="4" style="border: 1px solid #c2c9cb"><%Response.Write(findingReader["auditeeResp"]);%></textarea></td>
                            ...
                            <tr><th>ምላሹን የሰጠው የድርጅቱ ተውካይ</th><td><input type="text" id="respfname<%Response.Write(findingReader["findingId"]);%>" style="border: 1px solid #c2c9cb" class="form-control" placeholder="ስም"  value="<%Response.Write(findingReader["respfname"]);%>">&nbsp<input type="text" id="resplname<%Response.Write(findingReader["findingId"]);%>" style="border: 1px solid #552222;" class="form-control" placeholder="የአባት ስም" value="<%Response.Write(findingReader["resplname"]);%>"></td></tr>
              
                        <tr><th>ምላሽ የተሰጠበት ቀን (E.C.)</th>
              ...
              <table class="table table-condensed table-responsive table-bordered table-striped">
                <tr style="background-color:#c2c9cb">
                    <th colspan="2" style="color: black"><h4><b>
                        <span class="glyphicon glyphicon-record"></span>ለእያንዳንዱ ግኝቶች የተሰጠ የማሻሻያ ሃሳቦችን መዝግብ</b></h4>
                    </th>
                </tr>
                </table>
                </div>
                ...
                <tr><td colspan="3"><span class="glyphicon glyphicon-arrow-down"></span> <b>ማሻሻያ ሃሳብ ለመመዝገብ <u> ማሻሻያ ሃሳብ ጨምር </u> ን ጠቅ ያድርጉ</b></td></tr>
                <%
                    try
                    {
                        con.Open();
                        ...
                        %>
                        <tr><td><button class="btn btn-link" onclick="openrecommendation(<%Response.Write(findingreader["findingId"]);%>)"><span class="glyphicon glyphicon-record"></span>ማሻሻያ ሃሳብ ጨምር</button></td><td><i style="color:green">ግኝት <%Response.Write(findingcounter);%></i></td><td><p><%Response.Write(findingreader["findingName"]);%></p></td></tr>
                         <tr><td colspan="3">
            ...
            <tr style="background-color:#c2c9cb;color:black"><th><h4><b>የተገምጋሚ ድርጅቱ አጠቃላይ አስተያየት</b></h4></th></tr>
            <tr><td><textarea class="form-control" id="opinion" placeholder="የተገምጋሚ አጠቃላይ ድርጅቱ አስተያየት..." rows="4" style="border:1px solid #c2c9cb"><%Response.Write(auditeeopinion);%></textarea></td></tr>
            <tr><td><button class="btn btn-primary" style="color:white" onclick="saveauditeeopinion()">መዝግብ</button><i style="color:blue" id="opnmsg"></i></td></tr>
            </table>
            
             <table class="table table-responsive table-condensed table-hover table-bordered table-striped" border="1">
            <tr style="background-color:#c2c9cb;color:black"><th><h4><b>የኦዲተሩ አጠቃላይ አስተያየት</b></h4></th></tr>
            <tr><td><textarea class="form-control" id="remark" placeholder="የኦዲተሩ አጠቃላይ አስተያየት..." rows="4" style="border:1px solid #c2c9cb"><%Response.Write(remark);%></textarea></td></tr>
            <tr><td><button class="btn btn-primary" style="color:white" onclick="saveremark()">መዝግብ</button><i style="color:blue" id="rmrkmsg"></i></td></tr>
            </table>

        <table class="table table-responsive table-condensed table-hover table-bordered table-striped">
     
     <tr><td colspan="2"> <a class="btn btn-link" style="color:white;background-color:#3479c6" href="auditor_recordActionPlan.aspx">የተገምጋሚ ድርጅቱን የትግበራ ዕቅዶች ለመዝገብ እዚህ ጠቅ አድርግ</a></td><td></td></tr>
     </table>
        </div>
    </div>
