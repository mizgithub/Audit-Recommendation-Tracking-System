...
<li><a style="cursor:pointer;" onclick="enterListreportTitle();$('#hidmenu').slideUp();"><span class="glyphicon glyphicon-book"></span> አትም</a></li>
</ul>
</li><li><a style="cursor:pointer;" onclick="showsetting()">ማጠቃለያ ፎርማት</a></li><li><a style="cursor:pointer;font-weight:bolder;background-color:#ddeeee;width:100%" onclick="showsettingListFormat()">ዝርዝር ፎርማት</a></li>
</ul>
  ...
  <center> <table class="" border="1" style="border:1px solid #c2c9cb;font-size:12px;background-color:white;width:100%;" id="tbl">
   ...
   if(grpby=="auditee"){
       ...
       int flag = 0;
        ...
        %>
         ...
         <tr style="background-color:#c2c9cb;color:black;font-size:16px;border-top:2px solid #c2c9cb;text-align:center"><th colspan="<%Response.Write(colspan);%>" align="center"><%Response.Write(minname);%></th></tr>
       
          <tr><th id="">የኦዲት ዓ/ም</th>
        <%
       ...
       %><th>የግኝቶች ትክክለኛ የፋይናንስ እሴት (ETB.)</th><%                                                                          
       }
       if(Request["c3"]=="t"){
          
       %><th>ግምታዊ የተደረጉ የግኝቶች ዋጋ (ETB.) </th><%                                                                          
       }
       if(Request["c4"]=="t"){
       ...
       %><th>የማሻሻያ ሃሳብ ግምታዊ ዋጋ (ETB.)</th><%                                                                          
       }
       if(Request["c6"]=="t"){
          
       %><th>ሙሉ በሙሉ ተግባራዊ የሆኑ ማሻሻያ ሃሳቦች ብዛት</th><%                                                                          
       }
       if(Request["c7"]=="t"){
          
       %><th>በከፊል ተግባራዊ የሆኑ ማሻሻያ ሃሳቦች ብዛት</th><%                                                                          
       }
       
       if(Request["c8"]=="t"){
          
       %><th>ያልተተገበሩ ማሻሻያ ሃሳቦች ብዛት</th><%                                                                          
       }
      if(Request["c9"]=="t"){
   ...
   else if (grpby == "finding")
   {
       ...
       while (findingtypereader.Read())
       {
        ...
        %>
         ...
         <tr><th>ተገምጋሚ ድርጅት</th><th>የኦዲት ዓ/ም</th>
      ...
      if(Request["c9"]=="t"){
       ...
       %></tr><%
           ...
           {
             %>
        <tr style="background-color:#ddeeee;font-size:larger"><th>ድምር</th><th></th>
        <%
   ...
   string sql2=sql.Replace("*","DISTINCT year");
        ...
        %>
         ...
         <tr style="background-color:#c2c9cb;color:black;font-size:16px;border-top:2px solid #c2c9cb;text-align:center"><th colspan="<%Response.Write(colspan);%>" align="center"><%Response.Write(auditreader["year"]);%> ዓ/ም</th></tr>
         <tr><th>ተገምጋሚ ድርጅት</th>
         <%
              //******************************************
       if(Request["c1"]=="t"){
