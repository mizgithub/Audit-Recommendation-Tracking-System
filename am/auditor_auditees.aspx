   ...
   %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
      ...
      <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../en/auditor_auditees.aspx"><img src="images/eng.png" width="20" height="10"/>English</a></div>
   <div class="row">
  ...
  <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
       <%con.Open();
         ...
         while (minreader.Read()) { 
           %>
           <tr><td style="width:5px;"><button class="btn btn-link" id="but<%Response.Write(minreader["minId"]);%>" onclick="toggleorg('<%Response.Write(minreader["minId"]);%>')"><span class="glyphicon glyphicon-menu-down"></span></button></td><td><%Response.Write(mincounter+++". "+minreader["minName"]);%></td></tr>
