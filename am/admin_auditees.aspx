   ...
   %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
      ...
      <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../en/admin_auditees.aspx"><img src="images/eng.png" width="20" height="10"/>English</a></div>
   <div class="row">
  ...
  <table class="table table-bordered table-condensed table-hover table-responsive table-striped">
       <%con.Open();
         ...
         <div class="panel panel-success"style="position:fixed;top:300px;left:10px;width:500px;height:250px;display:none;z-index:10;border:1px solid #02c9cb" id="buckupcontainer">
          ...
          <p style="color:black"><span class="glyphicon glyphicon-floppy-disk"></span>ምትከ ዉሰድ </p>
          </div>
