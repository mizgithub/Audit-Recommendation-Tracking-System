...
<script language="javascript">
    function searchfile() { 
       window.open("auditor_actionplanfiles.aspx?selauditee="+document.getElementById("selauditee").value+"&selyear="+document.getElementById("selyear").value+"&selaudittype="+document.getElementById("selaudittype").value,"_self");
    }
</script>
<style>
    .affix
...
<%
 ...
 <div class="panel panel-default" style="background-color:#c2c9cb; height:1000px;border-right:1px solid black">
    ...
    <td><button class="btn btn-primary"  onclick="searchfile()"><span class="glyphicon glyphicon-search"></span>Search action plan file</button></td>
         </tr>
         </table>
         <table class="table table-bordered table-condensed table-responsive table-striped">
         <tr style="background-color:#c2c9cb"><th colspan="5">Result (Click on the hyper link to download the file)</th></tr>
         <tr><td>File</td><td>Auditee</td><td>Audit type</td><td>Audit year</td><td>File uploaded date</td></tr>
         <%
            
             string sql = "select TOP 10 * from actionplanfile_Table where ftype=1";
