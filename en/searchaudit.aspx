...
<tr><th colspan="5" style="background-color:#c2c9cb;color:black"><h4>Search result</h4></th></tr>
   ...
   try
   {
       ...
       string sqlcounter = sql.Replace("*", "count(*)");
           ...
           if (res > 0) { 
           %>
           <tr><td colspan="5" style="font-weight:bold">Click on the hyper link to view audit detail or to record followup information</td></tr>
           <tr><td></td><td style="font-size:small">Audit title</td><td style="font-size:small">Auditee name</td><td style="font-size:small">Audit type</td><td style="font-size:small">Audit year</td></tr>
           <%
           }
