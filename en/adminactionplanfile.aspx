...
<script language="javascript">
    function searchfile() {
        window.open("adminactionplanfile.aspx?selauditee=" + document.getElementById("selauditee").value + "&selyear=" + document.getElementById("selyear").value + "&selaudittype=" + document.getElementById("selaudittype").value, "_self");
    }
    function makebakup() {
...
<%
 ...
 <div class="panel panel-default" style="background-color:#c2c9cb; height:700px;border-right:1px solid black">
    ...
    <td><button class="btn btn-primary"  onclick="searchfile()"><span class="glyphicon glyphicon-search"></span>Search action plan file</button></td>
        ...
        <tr><th colspan="5" style="background-color:#c2c9cb;color:black">Result</th></tr>
