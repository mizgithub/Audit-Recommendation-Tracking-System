...
<table class="table table-responsive table-condenced table-hover table-striped table-bordered">
   ...
   try
   {
       ...
       if (auditId == 0)
       {
           ...
           Response.Write("<h5>Click on <u>add action taken</u> button to record action taken</h5><b>Note:</b>You can not edit the value once you record it, so please make sure that you entered the corect value");
