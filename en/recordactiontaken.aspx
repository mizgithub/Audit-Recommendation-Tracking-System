...
<body>
    ...
    <table class="table table-responsive table-condensed table-hover table-bordered table-striped" style="border: 2px solid #c2c9cb;display:none" id="actiontakenform<%Response.Write(Request["planId"]);%>">
        <tr>
            <td colspan="2">
                <textarea class="form-control" id="actiontaken<%Response.Write(Request["planId"]);%>" placeholder="Write action taken description here..." rows="4" style="border:1px solid #c2c9cb"></textarea>
            </td>
        </tr>
         <tr>
