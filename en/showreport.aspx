...
<ul class="nav nav-tabs" style="border-bottom:1px solid #c2c9cb"><li><a class="btn btn-link btn-sm"style="cursor:pointer;background-color:#c2c9cb;color:black;border-radius:0px;" onclick="$('#hidmenu').slideToggle();" ><span class="glyphicon glyphicon-share"></span>Export</a>
...
<li><a style="cursor:pointer;" onclick="enterTitle();$('#hidmenu').slideUp();"><span class="glyphicon glyphicon-book"></span> To Pdf</a></li>
</ul>
</li><li><a style="cursor:pointer;font-weight:bolder;background-color:#ddeeee" onclick="showsetting()">Summary format</a></li><li><a style="cursor:pointer;width:100%" onclick="showsettingListFormat()">List format</a></li>
</ul><br>
<table class="table table-hover"><tr style="background-color:#c2c9cb;color:black;font-size:16px;text-align:center"><th>Summary report</th>
</tr></table>
<div  id="tableid">
 <%
   ...
   if(grpby=="auditee"){
      numofcolumns=1;
       %>
          <tr><th id="h1">Auditee</th>
        <%
       
       //******************************************
       if(Request["c1"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">No. of findings</th><%                                                                          
       }
       if(Request["c2"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Actual financial value of findings (ETB.)</th><%                                                                          
       }
       if(Request["c3"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Extrapolated financial value of findings (ETB.) </th><%                                                                          
       }
       if(Request["c4"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">No. of recomm.</th><%                                                                          
       }
       if(Request["c5"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Potential saving from recomm (ETB.)</th><%                                                                          
       }
       if(Request["c6"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">No. of fully implemented recomm.</th><%                                                                          
       }
       if(Request["c7"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">No. of partially implemented recomm.</th><%                                                                          
       }
       
       if(Request["c8"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">No. of not implemented recomm.</th><%                                                                          
       }
      if(Request["c9"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Recovered financial value (ETB.)</th><%                                                                          
       }
       if(Request["c10"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Unrecovered financial value (ETB.)</th><%                                                                          
       }
       %></tr><%
       ...
       if(Request["c1"]=="t"){
           numofcolumns++;
       %><th id="hd<%Response.Write(numofcolumns+""+rowcounter);%>"><a href="#" onclick="openfinding('<%Response.Write(fid);%>')"><%Response.Write(numoffinding);%></a></th><%                                                                          
       }
       if(Request["c2"]=="t"){
           numofcolumns++;
   ...
   else if (grpby == "finding")
   {
    numofcolumns=1;
       %>
          <tr><th id="h1">Finding type</th>
        <%
       
       //******************************************
       if(Request["c1"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Number of findings</th><%                                                                          
       }
       if(Request["c2"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Actual financial value of findings (ETB.)</th><%                                                                          
       ...
       if(Request["c4"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Number of recommendations</th><%                                                                          
       }
       if(Request["c5"]=="t"){
           numofcolumns++;
       %><th id="h<%Response.Write(numofcolumns);%>">Potential saving from recomm (ETB.)</th><%                                                                          
   ...
   else
   {
       numofcolumns=2;
       %>
          <tr><th id="h1">Audit year</th><th id="h2">Auditee</th>
        <%
      ...
      if(Request["c9"]=="t"){
       ...
       %></tr><%
                 ...
                 totfid += "0";
        %>
          <tr style="background-color:#ddeeee;font-size:larger"><th>Total</th><th>All</th>
        <%
 ...
 <%if (grpby != "0") { 
   %><table class="table"><tr><td style="text-align:right"><button class="btn btn-primary" style="text-align:left" onclick="$('#chartdiv').slideToggle();$('#chartContainer').slideToggle();"><span class="glyphicon glyphicon-signal"></span>Show chart</button></td></tr></table>
    <%
   }%>
 </div>
 ...
 <%if (detail == "detail")
   ...
   <tr style="background-color:#c2c9cb;color:black"><th>Detail of findings and recommendations</th></tr>
   </table>
   ...
   <%
       ...
       while (findingreader.Read()) {
           ...
           {
        %>
        <tr style="background-color:white; border-left:2px soild #c2c9cb;border-top:3px solid #c2c9cb"><th style="width:10%"><b style="font-size:18px">Finding <%Response.Write(findingcounter++);%></b><br><i style="font-size:12px;color:black"><br>Auditee:<br><u><%Response.Write(minname);%></u></i></th><td style="font-family:Times New Roman;text-align:justify"><%Response.Write(findingreader["findingName"]);%><br><i style="font-size:13px;"><b style="color:#33aa33">(Finding type: <%Response.Write(findingtype);%>)</b><br><button class="btn btn-link" onclick="showinaudit(<%Response.Write(findingreader["auditId"]);%>)"><span class="glyphicon glyphicon-share"></span>show in audit</button></i></td><td>Actual financial value<br><b><%Response.Write(Double.Parse(findingreader["actualValue"].ToString()).ToString("#,0.00"));%> ETB.</b></td><td>Extrapolated financial value<br><b><%Response.Write(Double.Parse(findingreader["extraValue"].ToString()).ToString("#,0.00"));%> ETB.</b></td></tr>
        ...
        <%
           ...
           { 
             ...
             <tr style="color:#000000;border-top:"><th colspan="5"><b style="font-size:18px">Recommendations</b></th></tr>
               <%
            ...
            %>
            <tr><th style="border-top:2px "><b style="font-size:18px">Recommendation<%Response.Write(recomcounter++);%></b><br><i style="font-size:12px;color:black"><br>Auditee:<br><u><%Response.Write(minname);%></u></i></th><td style="width:50%;color:black"><%Response.Write(recomreader["recomName"]);%><i><br><button class="btn btn-link" onclick="showinaudit(<%Response.Write(recomreader["auditId"]);%>)"><span class="glyphicon glyphicon-share"></span>show in audit</button></i></td><td style="border-top:">Potential saving<br><%Response.Write(Double.Parse(recomreader["potSaving"].ToString()).ToString("#,0.00"));%></td>
            <td style="width:100px;background-color:"><u><b>Current status</b></u><br>
              NOT IMPLEMENTED
            ...
            <%
             ...
             %>
            <tr><th><b style="font-size:18px">Recommendation<%Response.Write(recomcounter++);%></b><br><i style="font-size:12px;color:black"><br>Auditee:<br><u><%Response.Write(minname);%></u></i></th><td style="width:60%;"><%Response.Write(recomreader["recomName"]);%><i><br><button class="btn btn-link" onclick="showinaudit(<%Response.Write(findingreader["auditId"]);%>)"><span class="glyphicon glyphicon-share"></span>show in audit</button></i></td><td style="border-top:;">Potential saving<br><%Response.Write(Double.Parse(recomreader["potSaving"].ToString()).ToString("#,0.00"));%></td>
            <td style="border-top:;width:100px;background-color:"><u><b>Current status</b></u><br>
              FULLY IMPLEMENTED
            </td>
            <%
                   }
            %>
            <td>Extent of status<br><%Response.Write(recomreader["statusExtent"]);%></td></tr>
            ...
            <tr style="color:#000000;border-top:;border-bottom:"><th colspan="2">Action plan</th></tr>
            <%
                   con5.Open();
                   ...
                   while (actionplanreader.Read())
                   {
                       ...
                       {
                %>
                <tr><td><%Response.Write(actionplanreader["actionplan"]);%></td><td style="width:100px;background-color:#">Action plan date:<br><b style="color:blue"><%Response.Write(actionplanreader["actiondate"]);%></b></td></tr>
                <tr style="background-color:"><td style="color:blue !important;" colspan="2">Missed the deadline</td></tr>
                <%
                       }
                       else
                       { 
 ...
 <%}
  ...
  <%if (grpby != "0")
   ...
   <div class="btn-group">
   <button class="btn btn-link" onclick="$('#chartdiv').slideToggle();$('#chartContainer').slideToggle();"><b style="color:red">Close</b></button>
   <span >&nbsp;</span>
...
<tr  align="center" style=""><th colspan="4"><u><b>Your Setting</b></u></th></tr>
