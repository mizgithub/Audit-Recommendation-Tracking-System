   ...
   %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
       ...
       <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../am/admin_setting.aspx"><img src="images/et.png" width="20" height="10"/>አማርኛ</a></div>
   <div class="row">
    ...
    <tr><td><button class="btn btn-link" onclick="openauditdirectoratesetting()"><span class="glyphicon glyphicon-cog"></span> Audit directorate setting</button></td></tr>
    <tr><td><button class="btn btn-link" onclick="openfederalorgsetting()"><span class="glyphicon glyphicon-cog"></span> Auditee setting</button></td></tr>
    <tr><td><button class="btn btn-link" onclick="openaudittypesetting()"><span class="glyphicon glyphicon-cog"></span> Audit type setting</button></td></tr>
    <tr><td><button class="btn btn-link" onclick="openfindingtypesetting()"><span class="glyphicon glyphicon-cog"></span> Finding type setting</button></td></tr>
    ...
    <h3>Click on one of the setting buttons</h3>
