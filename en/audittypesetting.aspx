...
<%
 ...
 <% string conString = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
  ...
  %>
  <h4><span class="glyphicon glyphicon-plus"></span>Add new audit type</h4>
 <center> <span id="audtymsg"></span><table class="table" style="width:70%">
 <tr><td colspan="2"><input type="text" class="form-control" id="audittype" placeholder="Name of the Audit Type"></td></tr>
 <tr><td style="width:50%"></td><td><button class="btn btn-primary btn-block" onclick="saveaudittype()">Add</button></td></tr>
  </table>
  </center>
  <hr style="border:2px solid #777777">
    <h4><span class="glyphicon glyphicon-folder-close"></span>Saved audit types</h4>
    <table class="table">
    <%
        try
        {
