...
<% string conString = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
   ...
   %>
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
       ...
       <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../am/report.aspx"><img src="images/et.png" width="20" height="10"/>አማርኛ</a></div>
       <div style="background-color:white;text-align:left;"><a class="btn btn-link" style="background-color:#c2c9cb;color:black"onclick="$('#panelcontainer').slideToggle();" title="Hide/show panel"><span class="glyphicon glyphicon-menu-down"></span></a>&nbsp;<a href="auditor_home.aspx" class="btn btn-link" style="color:black;background-color:#c2c9cb" title="home"><span class="glyphicon glyphicon-home"></span></a></div>
   <div class="row">
