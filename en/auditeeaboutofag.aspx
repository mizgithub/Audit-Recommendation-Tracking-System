...
<%
   ...
   %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
      ...
      <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../am/auditeeaboutofag.aspx"><img src="images/et.png" width="20" height="10"/>አማርኛ</a></div>
   <div class="row">
 ...
 <div class="panel panel-default" style="background-color:#c2c9cb; height:1000px;border-right:1px solid black">
    ...
    <a href="logout.aspx" class="navbar-brand" style="color:White"><b>logout</b></a>
     </div>
