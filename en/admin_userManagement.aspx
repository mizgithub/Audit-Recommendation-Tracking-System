 ...
 %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
       ...
       <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../am/admin_userManagement.aspx"><img src="images/et.png" width="20" height="10"/>አማርኛ</a></div>
   <div class="row">
   ...
   <div class="panel panel-default" style="background-color:#c2c9cb; height:1200px;border-right:1px solid black">
    ...
    <!--************************************************-->
         ...
         <li><a class="" onclick="$('#form').slideToggle();$('#ctraud').slideUp();"><span class="glyphicon glyphicon-plus"></span>Create user account</a></li>
         <li><a class="" onclick="$('#form').slideUp();$('#ctraud').slideToggle();"><span class="glyphicon glyphicon-plus"></span>Create auditee account</a></li></ul>
          ...
          <center> <table class="table table-responsive table-bordered" border="1"><tr><td>
           <table class="table table-responsive table-bordered" style="width:100%;" border="1">
            <tr>
            <th style="width:150px">Auditee</th> <td>
     <select class="form-control" id="selauditee" style="border:1px solid black">
      ...
      <%try
        ...
        %>
            ...
            <tr>
            <th>Username</th><td><input type="text" class="form-control" id="auduname" style="border:0.5px solid #888888; font-size:larger" placeholder="unique user name"></td>
            </tr>

            <tr>
            <th>New password</th><td><input type="text" class="form-control" id="audpass" style="border:0.5px solid #888888"></td>
            </tr>

             <tr>
            <th>Confirm password</th><td><input type="text" class="form-control" id="audcpass" style="border:0.5px solid #888888"></td>
            </tr>
            <tr><td colspan="2"><button class="btn btn-primary btn-block" onclick="saveauditeeuser()">Add User</button></td></tr>
            </table>
            </td><td align="left" valign="center" style="width:50%">
              <h4 style="color:red;"id="auderrmsg"></h4><h4 style="color:#343434;text-align:justify">Enter the required information of the user.<br><b>NOTE:</b> The system generates unique username, but if you want to change, make sure that you Entered unique username.<h4></h4>
              </td></tr></table></center>
          </div>
          ...
          <center> <table class="table table-responsive table-bordered" border="1"><tr><td>
           <table class="table table-responsive table-bordered" style="width:100%;" border="1">
            <tr>
            <th style="width:150px">First name</th><td><input type="text" class="form-control" id="fname" style="border:0.5px solid #888888"></td>
            </tr>

            <tr>
            <th>Last name</th><td><input type="text" class="form-control" id="lname" style="border:0.5px solid #888888"></td>
            </tr>
             <tr>
            <th>User Role</th><td>
            ...
            <tr>
            <th>Username</th><td><input type="text" class="form-control" id="uname" style="border:0.5px solid #888888; font-size:larger" placeholder="unique user name" onfocus="generateusername()"></td>
            </tr>

            <tr>
            <th>New password</th><td><input type="text" class="form-control" id="pass" style="border:0.5px solid #888888"></td>
            </tr>

             <tr>
            <th>Confirm password</th><td><input type="text" class="form-control" id="cpass" style="border:0.5px solid #888888"></td>
            </tr>
            <tr><td colspan="2"><button class="btn btn-primary btn-block" onclick="saveuser()">Add user</button></td></tr>
            </table>
            </td><td align="left" valign="center" style="width:50%">
              <h4 style="color:red;"id="errormsg"></h4><h4 style="color:#343434;text-align:justify">Enter the required information of the user.<br><b>NOTE:</b> The system generates unique username, but if you want to change, make sure that you Entered unique username.<h4></h4>
              </td></tr></table></center>
          </div>
          ...
          <tr><th style="background-color:#c2c9cb;color:black"><h5 style="color:black;"><b>Registered users</b></h5></th><th style="background-color:#c2c9cb"><input type="text" class="form-control" id="reguser" style="width:200px;" placeholder="search user/first name" onkeyup="getregistereduser()"></th></tr></table>
