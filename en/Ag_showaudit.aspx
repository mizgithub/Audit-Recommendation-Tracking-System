...
<%
   ...
   <% string conString = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
    ...
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
      ...
      <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../am/Ag_showaudit.aspx?auditId=<%Response.Write(Request["auditId"]);%>"><img src="images/et.png" width="20" height="10"/>አማርኛ</a></div>
   <div class="row">
 ...
 <div class="panel panel-default" style="background-color:#c2c9cb; height:1200px;border-right:1px solid black">
    ...
    <div class="col-sm-10" style="padding-left:0px;height:1200px;overflow:auto;border-left:1px solid #552222">
    <!--  *******TOP Nagigation bar-->
    <div class="">
