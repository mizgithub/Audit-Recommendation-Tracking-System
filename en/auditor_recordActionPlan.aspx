 ...
 %>
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
      ...
      <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../am/auditor_recordActionPlan.aspx"><img src="images/et.png" width="20" height="10"/>አማርኛ</a></div>
   <div class="row">
  ...
  <div class="col-sm-2 panel panel-default" style="background-color:#c2c9cb; height:1000px;border-right:1px solid black;padding-right:0px;">
    ...
    <a href="logout.aspx" class="navbar-brand" style="color:black"><b>Logout</b></a>
     ...
     <tr style="background-color:#c2c9cb;color:black"><th><h4><b>Auditee action plan</b></h4></th></tr>
     </table>
     <div class="row">
     <div class="col-sm-12" style="padding-left:20px;">
      <table class="table table-responsive table-hover table-bordered table-striped">
      <tr><th colspan="3"><span class="glyphicon glyphicon-arrow-down"></span>Click on <u>Add action plan</u> to record action plan</th></tr>
      <%
          try
          {
              con.Open();
              ...
              while (recomreader.Read()) {
                   ...
                   %>
              <tr><td style="width:100px"><button class="btn btn-link" onclick="$('#actioncontent<%Response.Write(recomreader["recomId"]);%>').slideToggle();openactionplan(<%Response.Write(recomreader["recomId"]);%>)"><span class="glyphicon glyphicon-record"></span>Add action plan</button></td><th style="width:7px;"><i style="color:black">Recomm. <%Response.Write(recomcounter);%></i></th><th><%Response.Write(recomreader["recomName"]);%></th></tr>
              <tr><td colspan="3">
     ...
     <table class="table table-responsive table-condensed table-bordered table-striped">
     <tr style="background-color:#c2c9cb;color:black"><th><h4><b>Action taken by the auditee</b></h4></th></tr>
     </table>
     <table class="table table-responsive table-hover table-bordered table-striped">
      <tr><th colspan="3"><span class="glyphicon glyphicon-arrow-down"></span>Click on <u>Add action taken</u> to record action taken</th></tr>
       <%
                    try
                    {
                        con.Open();
                        ...
                        %>
                         <tr><td><button class="btn btn-link" onclick="$('#recomcontent<%Response.Write(actionplanreader["recomId"]);%>').slideToggle();openactiontaken(<%Response.Write(actionplanreader["recomId"]);%>)"><span class="glyphicon glyphicon-record"></span>Add action taken</button></td><td style=""><i style="color:green">Action plan <%Response.Write(plancounter);%></i></td><td><p><%Response.Write(actionplanreader["actionplan"]);%></p></td></tr>
     ...
     <tr style="background-color:#c2c9cb;color:black"><th colspan="3"><h4><b>Audit followup information</b></h4></th></tr>
     <tr><td style="width:150px">Followup date</td><td><input type="date" id="folldate" class="form-control" value="<%Response.Write(followupdate);%>" style="border:1px solid #c2c9cb"><br></td><td></td></tr>
     <tr><td>Auditor Next steps</td><td><textarea class="form-control" rows="4" id="nextstep" style="border:1px solid #c2c9cb" placeholder="Write auditor next step here...."><%Response.Write(nextstep);%></textarea></td></tr>
     <tr><td>Auditor Assigned To initiate Next step</td><td><input type="text" class="form-control" id="audfname" style="width:200px;border:1px solid #c2c9cb" placeholder="first name" value="<%Response.Write(fname);%>">&nbsp;&nbsp;&nbsp;<input type="text" class="form-control" id="audlname" style="width:200px;border:1px solid #888899" placeholder="last name" value="<%Response.Write(lname);%>"></td></tr>
     <tr><td>Action taken by auditor</td><td><textarea class="form-control" rows="4" id="act" style="border:1px solid #c2c9cb" placeholder="Write actual actions taken by auditor here...."><%Response.Write(action);%></textarea></td></tr>
     <tr><td><button class="btn btn-primary btn-block" onclick="savefollowupdate()">Save</button></td><td id="follmsg"></td></tr>
     </table>
     
     <br>
     <table class="table table-responsive table-condensed table-hover table-bordered table-striped">
     <tr style="background-color:#c2c9cb;color:black"><th colspan="3"><h4><b>Submit the Audit</b></h4></th></r>
     <tr><td colspan="3"><p style="font-family:Times New Roman;font-size:larger">
     <br> 
     <br><b>Note. you can not edit the audit once you submit it.</b></p>
     <br><div id="submitmsg">
     </div>
     </td></tr>
     <tr><td colspan="3"><button class="btn btn-primary" style="width:300px;" onclick="submittheaudit()">Click here to submit</button></td></tr>
     </table>
