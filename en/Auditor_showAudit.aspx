   ...
   <% string conString = WebConfigurationManager.ConnectionStrings["connectionString"].ConnectionString;
    ...
    <div class="" style="height:70px;">
     ...
     <img src="images/logoimg.png" style="height:70px;" class="btn-block img-responsive"/>
       ...
       <div style="background-color:white;text-align:right;padding-right:20px;"><a href="../am/Auditor_showAudit.aspx?auditId=<%Response.Write(Request["auditId"]);%>"><img src="images/et.png" width="20" height="10"/>አማርኛ</a></div>
   <div class="row">
        ...
        <%try
          {
              ...
              con.Close();
              %>
              <tr style="background-color:white;color:black"><th colspan="5">Findings</th></tr>
